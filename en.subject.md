...
• Trytoalwayscodeusing C++ features when available (for example, choose <cstring>
...
0.
After a read/recv or a write/send, you must not rely on errno to
decide what to do next (for instance, reading again after errno ==
EAGAIN). Doing so will set your grade to 0.
